...
![](../results/horse_pops_plot.png){#fig-figure1 width=80%}
...
```{python}
#| label: tbl-horse-sd
#| tbl-cap: "Standard deviation of historical horse populations for each Canadian province."
...
Additionally, note that in Table 1 @tbl-horse-sd we consider the sample standard deviation of the number of horses during the same time span as Figure 1.

![](../results/horse_pops_plot_largest_sd.png){#fig-figure2 width=65%}
